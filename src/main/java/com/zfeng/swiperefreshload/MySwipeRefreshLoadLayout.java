 ...
 */
public class MySwipeRefreshLoadLayout extends ViewGroup {
   ...
   */
  public MySwipeRefreshLoadLayout(Context context) {
    this(context, null);
  }
   ...
   */
  public MySwipeRefreshLoadLayout(Context context, AttributeSet attrs) {
    super(context, attrs);
   ...
   */
  @Deprecated public void setColorScheme(int... colors) {
      ...
      case MotionEvent.ACTION_CANCEL:
        if (canChildScrollUp()) {
          if (mTarget instanceof AbsListView) {
            ...
            StaggeredGridLayoutManager lLManager =
                (StaggeredGridLayoutManager) recyclerView.getLayoutManager();

            if (lLManager.findLastVisibleItemPositions(new int[] { 1 })[0]
                == lLManager.getItemCount()) {
              if (mCanLoadMore) {
                mCanLoadMore = false;
                mLoadMoreListener.loadMore();
              }
